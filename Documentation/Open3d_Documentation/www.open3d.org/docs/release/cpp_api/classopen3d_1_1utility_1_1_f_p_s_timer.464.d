...
<!-- Mirrored from www.open3d.org/docs/release/cpp_api/classopen3d_1_1utility_1_1_f_p_s_timer.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 14 May 2023 10:56:43 GMT -->
<head>
<meta http-equiv="Content-Type" content="text/xhtml;charset=UTF-8"/>
<meta http-equiv="X-UA-Compatible" content="IE=9"/>
<meta name="generator" content="Doxygen 1.9.1"/>
<meta name="viewport" content="width=device-width, initial-scale=1"/>
<title>Open3D (C++ API): open3d::utility::FPSTimer Class Reference</title>
...
<div id="nav-path" class="navpath">
  <ul>
<li class="navelem"><a class="el" href="namespaceopen3d.html">open3d</a></li><li class="navelem"><a class="el" href="namespaceopen3d_1_1utility.html">utility</a></li><li class="navelem"><a class="el" href="classopen3d_1_1utility_1_1_f_p_s_timer.464.d">FPSTimer</a></li>  </ul>
</div>
</div><!-- top -->
<div class="header">
  <div class="summary">
...
<div class="title">open3d::utility::FPSTimer Class Reference</div>  </div>
</div><!--header-->
<div class="contents">

<p><code>#include &lt;<a class="el" href="_timer_8h_source.html">Timer.h</a>&gt;</code></p>
<div class="dynheader">
Inheritance diagram for open3d::utility::FPSTimer:</div>
<div class="dyncontent">
 <div class="center">
  <img src="classopen3d_1_1utility_1_1_f_p_s_timer.6d0.d" usemap="#open3d::utility::FPSTimer_map" alt=""/>
  <map id="open3d::utility::FPSTimer_map" name="open3d::utility::FPSTimer_map">
<area href="classopen3d_1_1utility_1_1_timer.html" alt="open3d::utility::Timer" shape="rect" coords="0,0,150,24"/>
  </map>
</div></div>
<table class="memberdecls">
<tr class="heading"><td colspan="2"><h2 class="groupheader"><a name="pub-methods"></a>
Public Member Functions</h2></td></tr>
<tr class="memitem:ac491168c7328f7b4a03da38bac0bbc30"><td class="memItemLeft" align="right" valign="top">&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classopen3d_1_1utility_1_1_f_p_s_timer.464.d#ac491168c7328f7b4a03da38bac0bbc30">FPSTimer</a> (const std::string &amp;fps_timer_info=&quot;&quot;, int expectation=-1, double time_to_print=3000.0, int events_to_print=100)</td></tr>
<tr class="separator:ac491168c7328f7b4a03da38bac0bbc30"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:a85a86aed8c997ec3133d53c2d4f2e139"><td class="memItemLeft" align="right" valign="top">void&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classopen3d_1_1utility_1_1_f_p_s_timer.464.d#a85a86aed8c997ec3133d53c2d4f2e139">Signal</a> ()</td></tr>
<tr class="separator:a85a86aed8c997ec3133d53c2d4f2e139"><td class="memSeparator" colspan="2">&#160;</td></tr>
...
<a id="ac491168c7328f7b4a03da38bac0bbc30"></a>
<h2 class="memtitle"><span class="permalink"><a href="#ac491168c7328f7b4a03da38bac0bbc30">&#9670;&nbsp;</a></span>FPSTimer()</h2>

<div class="memitem">
<div class="memproto">
      <table class="memname">
        <tr>
          <td class="memname">open3d::utility::FPSTimer::FPSTimer </td>
          <td>(</td>
          <td class="paramtype">const std::string &amp;&#160;</td>
          <td class="paramname"><em>fps_timer_info</em> = <code>&quot;&quot;</code>, </td>
        </tr>
        <tr>
          <td class="paramkey"></td>
          <td></td>
          <td class="paramtype">int&#160;</td>
          <td class="paramname"><em>expectation</em> = <code>-1</code>, </td>
        </tr>
        <tr>
          <td class="paramkey"></td>
          <td></td>
          <td class="paramtype">double&#160;</td>
          <td class="paramname"><em>time_to_print</em> = <code>3000.0</code>, </td>
        </tr>
        <tr>
          <td class="paramkey"></td>
          <td></td>
          <td class="paramtype">int&#160;</td>
          <td class="paramname"><em>events_to_print</em> = <code>100</code>&#160;</td>
        </tr>
        <tr>
          <td></td>
          <td>)</td>
...
<a id="a85a86aed8c997ec3133d53c2d4f2e139"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a85a86aed8c997ec3133d53c2d4f2e139">&#9670;&nbsp;</a></span>Signal()</h2>

<div class="memitem">
<div class="memproto">
      <table class="memname">
        <tr>
          <td class="memname">void open3d::utility::FPSTimer::Signal </td>
          <td>(</td>
...
<p>Function to signal an event It automatically prints FPS information when duration is more than time_to_print_, or event has been signaled events_to_print_ times. </p>
