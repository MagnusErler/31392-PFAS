...
<!-- Mirrored from www.open3d.org/docs/release/python_api/open3d.geometry.KDTreeSearchParamHybrid.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 14 May 2023 10:51:55 GMT -->
<head>
  <meta charset="utf-8">
  
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  
  <title>open3d.geometry.KDTreeSearchParamHybrid &mdash; Open3D 0.17.0 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/theme_overrides.css" type="text/css" />
    ...
    <link rel="next" title="open3d.geometry.KDTreeSearchParamKNN" href="open3d.geometry.KDTreeSearchParamKNN.d0.d" />
    <link rel="prev" title="open3d.geometry.KDTreeSearchParam" href="open3d.geometry.KDTreeSearchParam.ce.dela" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">KDTreeSearchParamHybrid</a></li>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li>open3d.geometry.KDTreeSearchParamHybrid</li>
...
<div class="section" id="open3d-geometry-kdtreesearchparamhybrid">
<h1>open3d.geometry.KDTreeSearchParamHybrid<a class="headerlink" href="#open3d-geometry-kdtreesearchparamhybrid" title="Permalink to this headline">¶</a></h1>
<dl class="py class">
<dt id="open3d.geometry.KDTreeSearchParamHybrid">
<em class="property">class </em><code class="sig-prename descclassname">open3d.geometry.</code><code class="sig-name descname">KDTreeSearchParamHybrid</code><a class="headerlink" href="#open3d.geometry.KDTreeSearchParamHybrid" title="Permalink to this definition">¶</a></dt>
<dd><p>KDTree search parameters for hybrid KNN and radius search.</p>
<dl class="py class">
<dt id="open3d.geometry.KDTreeSearchParamHybrid.Type">
<em class="property">class </em><code class="sig-name descname">Type</code><a class="headerlink" href="#open3d.geometry.KDTreeSearchParamHybrid.Type" title="Permalink to this definition">¶</a></dt>
<dd><p>Enum class for Geometry types.</p>
<dl class="py attribute">
<dt id="open3d.geometry.KDTreeSearchParamHybrid.Type.HybridSearch">
<code class="sig-name descname">HybridSearch</code><em class="property"> = &lt;Type.HybridSearch: 2&gt;</em><a class="headerlink" href="#open3d.geometry.KDTreeSearchParamHybrid.Type.HybridSearch" title="Permalink to this definition">¶</a></dt>
<dd></dd></dl>

<dl class="py attribute">
<dt id="open3d.geometry.KDTreeSearchParamHybrid.Type.KNNSearch">
<code class="sig-name descname">KNNSearch</code><em class="property"> = &lt;Type.KNNSearch: 0&gt;</em><a class="headerlink" href="#open3d.geometry.KDTreeSearchParamHybrid.Type.KNNSearch" title="Permalink to this definition">¶</a></dt>
<dd></dd></dl>

<dl class="py attribute">
<dt id="open3d.geometry.KDTreeSearchParamHybrid.Type.RadiusSearch">
<code class="sig-name descname">RadiusSearch</code><em class="property"> = &lt;Type.RadiusSearch: 1&gt;</em><a class="headerlink" href="#open3d.geometry.KDTreeSearchParamHybrid.Type.RadiusSearch" title="Permalink to this definition">¶</a></dt>
<dd></dd></dl>

<dl class="py method">
<dt id="open3d.geometry.KDTreeSearchParamHybrid.Type.value">
<em class="property">property </em><code class="sig-name descname">value</code><a class="headerlink" href="#open3d.geometry.KDTreeSearchParamHybrid.Type.value" title="Permalink to this definition">¶</a></dt>
<dd></dd></dl>

</dd></dl>

<dl class="py method">
<dt id="open3d.geometry.KDTreeSearchParamHybrid.__init__">
<code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">self</span><span class="p">:</span> <span class="n">open3d.cpu.pybind.geometry.KDTreeSearchParamHybrid</span></em>, <em class="sig-param"><span class="n">radius</span><span class="p">:</span> <span class="n">float</span></em>, <em class="sig-param"><span class="n">max_nn</span><span class="p">:</span> <span class="n">int</span></em><span class="sig-paren">)</span> &#x2192; None<a class="headerlink" href="#open3d.geometry.KDTreeSearchParamHybrid.__init__" title="Permalink to this definition">¶</a></dt>
<dd></dd></dl>

<dl class="py method">
<dt id="open3d.geometry.KDTreeSearchParamHybrid.get_search_type">
<code class="sig-name descname">get_search_type</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">self</span></em><span class="sig-paren">)</span><a class="headerlink" href="#open3d.geometry.KDTreeSearchParamHybrid.get_search_type" title="Permalink to this definition">¶</a></dt>
<dd><p>Get the search type (KNN, Radius, Hybrid) for the search parameter.</p>
<dl class="field-list simple">
<dt class="field-odd">Returns</dt>
<dd class="field-odd"><p>open3d.geometry.KDTreeSearchParam.SearchType</p>
</dd>
</dl>
</dd></dl>

<dl class="py attribute">
<dt id="open3d.geometry.KDTreeSearchParamHybrid.HybridSearch">
<code class="sig-name descname">HybridSearch</code><em class="property"> = &lt;Type.HybridSearch: 2&gt;</em><a class="headerlink" href="#open3d.geometry.KDTreeSearchParamHybrid.HybridSearch" title="Permalink to this definition">¶</a></dt>
<dd></dd></dl>

<dl class="py attribute">
<dt id="open3d.geometry.KDTreeSearchParamHybrid.KNNSearch">
<code class="sig-name descname">KNNSearch</code><em class="property"> = &lt;Type.KNNSearch: 0&gt;</em><a class="headerlink" href="#open3d.geometry.KDTreeSearchParamHybrid.KNNSearch" title="Permalink to this definition">¶</a></dt>
<dd></dd></dl>

<dl class="py attribute">
<dt id="open3d.geometry.KDTreeSearchParamHybrid.RadiusSearch">
<code class="sig-name descname">RadiusSearch</code><em class="property"> = &lt;Type.RadiusSearch: 1&gt;</em><a class="headerlink" href="#open3d.geometry.KDTreeSearchParamHybrid.RadiusSearch" title="Permalink to this definition">¶</a></dt>
<dd></dd></dl>

<dl class="py method">
<dt id="open3d.geometry.KDTreeSearchParamHybrid.max_nn">
<em class="property">property </em><code class="sig-name descname">max_nn</code><a class="headerlink" href="#open3d.geometry.KDTreeSearchParamHybrid.max_nn" title="Permalink to this definition">¶</a></dt>
<dd><p>At maximum, <code class="docutils literal notranslate"><span class="pre">max_nn</span></code> neighbors will be searched.</p>
</dd></dl>

<dl class="py method">
<dt id="open3d.geometry.KDTreeSearchParamHybrid.radius">
<em class="property">property </em><code class="sig-name descname">radius</code><a class="headerlink" href="#open3d.geometry.KDTreeSearchParamHybrid.radius" title="Permalink to this definition">¶</a></dt>
<dd><p>Search radius.</p>
</dd></dl>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="open3d.geometry.KDTreeSearchParamKNN.d0.d" class="btn btn-neutral float-right" title="open3d.geometry.KDTreeSearchParamKNN" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="open3d.geometry.KDTreeSearchParam.ce.dela" class="btn btn-neutral float-left" title="open3d.geometry.KDTreeSearchParam" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left"></span> Previous</a>
