...
<!-- Mirrored from www.open3d.org/docs/release/python_api/open3d.geometry.KDTreeSearchParamKNN.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 14 May 2023 10:51:55 GMT -->
<head>
  <meta charset="utf-8">
  
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  
  <title>open3d.geometry.KDTreeSearchParamKNN &mdash; Open3D 0.17.0 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/theme_overrides.css" type="text/css" />
    ...
    <link rel="next" title="open3d.geometry.KDTreeSearchParamRadius" href="open3d.geometry.KDTreeSearchParamRadius.d" />
    <link rel="prev" title="open3d.geometry.KDTreeSearchParamHybrid" href="open3d.geometry.KDTreeSearchParamHybrid.c" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">KDTreeSearchParamKNN</a></li>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li>open3d.geometry.KDTreeSearchParamKNN</li>
...
<div class="section" id="open3d-geometry-kdtreesearchparamknn">
<h1>open3d.geometry.KDTreeSearchParamKNN<a class="headerlink" href="#open3d-geometry-kdtreesearchparamknn" title="Permalink to this headline">¶</a></h1>
<dl class="py class">
<dt id="open3d.geometry.KDTreeSearchParamKNN">
<em class="property">class </em><code class="sig-prename descclassname">open3d.geometry.</code><code class="sig-name descname">KDTreeSearchParamKNN</code><a class="headerlink" href="#open3d.geometry.KDTreeSearchParamKNN" title="Permalink to this definition">¶</a></dt>
<dd><p>KDTree search parameters for pure KNN search.</p>
<dl class="py class">
<dt id="open3d.geometry.KDTreeSearchParamKNN.Type">
<em class="property">class </em><code class="sig-name descname">Type</code><a class="headerlink" href="#open3d.geometry.KDTreeSearchParamKNN.Type" title="Permalink to this definition">¶</a></dt>
<dd><p>Enum class for Geometry types.</p>
<dl class="py attribute">
<dt id="open3d.geometry.KDTreeSearchParamKNN.Type.HybridSearch">
<code class="sig-name descname">HybridSearch</code><em class="property"> = &lt;Type.HybridSearch: 2&gt;</em><a class="headerlink" href="#open3d.geometry.KDTreeSearchParamKNN.Type.HybridSearch" title="Permalink to this definition">¶</a></dt>
<dd></dd></dl>

<dl class="py attribute">
<dt id="open3d.geometry.KDTreeSearchParamKNN.Type.KNNSearch">
<code class="sig-name descname">KNNSearch</code><em class="property"> = &lt;Type.KNNSearch: 0&gt;</em><a class="headerlink" href="#open3d.geometry.KDTreeSearchParamKNN.Type.KNNSearch" title="Permalink to this definition">¶</a></dt>
<dd></dd></dl>

<dl class="py attribute">
<dt id="open3d.geometry.KDTreeSearchParamKNN.Type.RadiusSearch">
<code class="sig-name descname">RadiusSearch</code><em class="property"> = &lt;Type.RadiusSearch: 1&gt;</em><a class="headerlink" href="#open3d.geometry.KDTreeSearchParamKNN.Type.RadiusSearch" title="Permalink to this definition">¶</a></dt>
<dd></dd></dl>

<dl class="py method">
<dt id="open3d.geometry.KDTreeSearchParamKNN.Type.value">
<em class="property">property </em><code class="sig-name descname">value</code><a class="headerlink" href="#open3d.geometry.KDTreeSearchParamKNN.Type.value" title="Permalink to this definition">¶</a></dt>
<dd></dd></dl>

</dd></dl>

<dl class="py method">
<dt id="open3d.geometry.KDTreeSearchParamKNN.__init__">
<code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">self</span><span class="p">:</span> <span class="n">open3d.cpu.pybind.geometry.KDTreeSearchParamKNN</span></em>, <em class="sig-param"><span class="n">knn</span><span class="p">:</span> <span class="n">int</span> <span class="o">=</span> <span class="default_value">30</span></em><span class="sig-paren">)</span> &#x2192; None<a class="headerlink" href="#open3d.geometry.KDTreeSearchParamKNN.__init__" title="Permalink to this definition">¶</a></dt>
<dd></dd></dl>

<dl class="py method">
<dt id="open3d.geometry.KDTreeSearchParamKNN.get_search_type">
<code class="sig-name descname">get_search_type</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">self</span></em><span class="sig-paren">)</span><a class="headerlink" href="#open3d.geometry.KDTreeSearchParamKNN.get_search_type" title="Permalink to this definition">¶</a></dt>
...
<dl class="py attribute">
<dt id="open3d.geometry.KDTreeSearchParamKNN.HybridSearch">
<code class="sig-name descname">HybridSearch</code><em class="property"> = &lt;Type.HybridSearch: 2&gt;</em><a class="headerlink" href="#open3d.geometry.KDTreeSearchParamKNN.HybridSearch" title="Permalink to this definition">¶</a></dt>
<dd></dd></dl>

<dl class="py attribute">
<dt id="open3d.geometry.KDTreeSearchParamKNN.KNNSearch">
<code class="sig-name descname">KNNSearch</code><em class="property"> = &lt;Type.KNNSearch: 0&gt;</em><a class="headerlink" href="#open3d.geometry.KDTreeSearchParamKNN.KNNSearch" title="Permalink to this definition">¶</a></dt>
<dd></dd></dl>

<dl class="py attribute">
<dt id="open3d.geometry.KDTreeSearchParamKNN.RadiusSearch">
<code class="sig-name descname">RadiusSearch</code><em class="property"> = &lt;Type.RadiusSearch: 1&gt;</em><a class="headerlink" href="#open3d.geometry.KDTreeSearchParamKNN.RadiusSearch" title="Permalink to this definition">¶</a></dt>
<dd></dd></dl>

<dl class="py method">
<dt id="open3d.geometry.KDTreeSearchParamKNN.knn">
<em class="property">property </em><code class="sig-name descname">knn</code><a class="headerlink" href="#open3d.geometry.KDTreeSearchParamKNN.knn" title="Permalink to this definition">¶</a></dt>
<dd><p>Number of the neighbors that will be searched.</p>
</dd></dl>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="open3d.geometry.KDTreeSearchParamRadius.d" class="btn btn-neutral float-right" title="open3d.geometry.KDTreeSearchParamRadius" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="open3d.geometry.KDTreeSearchParamHybrid.c" class="btn btn-neutral float-left" title="open3d.geometry.KDTreeSearchParamHybrid" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left"></span> Previous</a>
